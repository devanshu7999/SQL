...
--A1
-- Display customer name, city, customer segment, order ID, order date, and 
-- order status for every order placed in 2025.
select * from Customers;
select 
c.customer_name, c.city, c.customer_segment,
o.order_id, o.order_date, o.order_status
from Customers as c
join Orders as o
on c.customer_id = o.customer_id
where registration_date like '2025%';


--A2
-- Find all customers from Gujarat who belong to the Premium or Enterprise segment.
-- Display customer name, city, and segment.
select * from
Customers
where customer_segment = 'Premium' or customer_segment='Enterprise';


--A3
-- Display all products whose unit price is between ₹5,000 and ₹20,000, sorted from 
...
--A4
-- Find all completed orders where the quantity is greater than 4. Display order ID, 
-- customer ID, product ID, quantity, and order date.
select o.order_id, c.customer_id, o.quantity, o.order_date from
Orders as o
join Customers as c 
on c.customer_id = o.customer_id 
where o.quantity>4;
...
select product_id from Products where stock_quantity>4;


--A5
-- Display the five most expensive products. 
-- Show product name, category, and unit price.
...
select count(*) as  'Total number of customers in Enterprise' from Customers where customer_segment='Enterprise';

select count(*) as  'Total number of customers in Premium' from Customers where customer_segment='Premium';

select count(*) as  'Total number of customers in Standard' from Customers where customer_segment='Standard';


-- A7
select sum(quantity) as 'Total quantity of products ordered for each product' from Orders;

select sum(o.quantity) as 'Total quantity of products ordered for each product' from Orders as o
join Products as p
on o.product_id = p.product_id
where product_name='Laptop Pro 14' or 
product_name='Business Laptop 15';

--'Products' table 'product_name' col:
-- Laptop Pro 14, Business Laptop 15, 
-- Wireless Mouse, Mechanical Keyboard, 
-- USB-C Dock, 24-inch Monitor